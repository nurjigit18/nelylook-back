...
IS_DEVELOPMENT = ENVIRONMENT == "dev" or DEBUG
...
# Development vs Production API docs
if IS_DEVELOPMENT:
...
# JWT Configuration
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=1 if IS_DEVELOPMENT else minutes=15),
    "REFRESH_TOKEN_LIFETIME": timedelta(days=30 if IS_DEVELOPMENT else days=7),
    "ROTATE_REFRESH_TOKENS": not IS_DEVELOPMENT,
    "BLACKLIST_AFTER_ROTATION": not IS_DEVELOPMENT,
